...
1. Set AWS_REGION and COMUNIO_SECRET_NAME for secret mode.
...
1. Align `src/ingest/comuniopy_client.py` with the current API contract.
...
1. Fix migration ordering/content.
1. Re-run after correction.
