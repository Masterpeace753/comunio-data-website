...
1. Produce findings with severity, evidence, impact, and concrete fix guidance.
1. Create or update a review document in docs/code-review.
1. Include a clear go/no-go production readiness recommendation.
